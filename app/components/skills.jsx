  ...
  return (
    ...
    >
      ...
      <summary className="grid-container grid grid-cols-2 gap-x-14 gap-y-4 max-[377px]:gap-x-3 max-[378px]:gap-y-[4rem] max-[378px]:grid-cols-1 w-full">
        ...
        <Card
          icon={
            <TbBrandNextjs className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="NextJs"
        ...
        <Card
          icon={
            <DiHtml5 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="HTML"
        ...
        <Card
          icon={
            <DiCss3 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="CSS"
          description="3 years of experience, i have used it all over every web project i've ever had"
        />
        <Card
          icon={
            <DiJavascript1 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="JavaScript"
        ...
        <Card
          icon={
            <DiNodejs className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="NodeJs"
        ...
        <Card
          icon={
            <SiExpress className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="Express"
        ...
        <Card
          icon={
            <DiMongodb className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem] max-[414px]:w-[3rem] max-[300px]:w-[2.5rem]" />
          }
          name="MongoDB"
