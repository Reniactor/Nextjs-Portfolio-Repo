        ...
        <section id='skills' className='w-full flex flex-col items-center gap-4 mb-24 min-[805px]:pt-36'>
            <h1 className='text-7xl font-PlayfairDisplay font-bold mb-8'>Skills</h1>
                <div className='grid-container grid grid-cols-2 gap-x-16 gap-y-4'>
                    <Card
                    icon={<DiReact className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='ReactJs'
                    description='1.5 years of experience (As a matter of fact, this page was built with it!)'
                    />
                    <Card
                    icon={<TbBrandNextjs className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='NextJs'
                    description='1 year of experience (This page also used NextJs, along with tailwindcss)'
                    />
                    <Card
                    icon={<DiHtml5 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='HTML'
                    description="3 years of experience, i have used it all over every web project i've ever had"
                    />
                    <Card
                    icon={<DiCss3 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='CSS'
                    description="3 years of experience, i have used it all over every web project i've ever had"
                    />
                    <Card
                    icon={<DiJavascript1 className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='JavaScript'
                    description='3 years of experience, including the use of a wide variety of libraries'
                    />
                    <Card
                    icon={<DiNodejs className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='NodeJs'
                    description='1.5 years of experience. Mainly by building automation tools for startups'
                    />
                    <Card
                    icon={<SiExpress className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='Express'
                    description="1 year of experience. Used along with NodeJs projects i've had ever since i learnt it"
                    />
                    <Card
                    icon={<DiMongodb className="text-color10 w-[4.5rem] h-auto min[805px]:w-[7.8rem]"/>}
                    name='MongoDB'
